...
%>
<section>
	<div class="content1 d-flex border  border-success p-3"> 
		<div class="mr-3">
			<img src="<%=artistInfo.get("photo")%>" alt="사진" width="100px"
				height="100px">
		</div>
		<div>
			<h3 class="font-weight-bold mb-2"><%=artistInfo.get("name")%></h3>
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					<td><%=list.get("id")%></td>
					<td><a
						href="/lesson03/quiz02/template.jsp?id=<%=list.get("id")%>"><%=list.get("title")%></a></td>
